...
def prelude():
    ...
    play_note(5, 1.5, track)
    play_note(6, 0.5, track)
    play_note(7, 0.5, track)
    play_note(1, 0.5, track, 1)
    play_note(2, 2, track, 1)
    play_note(3, 1, track, 1)

    play_note(4, 4, track, 1)
    play_note(3, 1, track, 1)
    play_note(2, 1, track, 1)

    play_note(1, 12, track, 1)
...
def precorus():
    ...
    play_note(5, 1, track, velocity=0)

    play_note(1, 1, track)
    play_note(3, 1, track)
    play_note(1, 1, track, 1)
    play_note(7, 1, track)
    play_note(6, 1.5, track)
    play_note(3, 0.5, track)
    ...
    play_note(2, 3, track)
    play_note(6, 3, track, -1)

    play_note(7, 1, track, -1)
    play_note(6, 1, track, -1)
    play_note(5, 1, track, -1)
    play_note(5, 1, track)
    play_note(1, 1.5, track)
    play_note(2, 0.5, track)
...
def postlude():
    play_note(4, 3, track)
    play_note(2, 8, track, 1)
    play_note(1, 1, track, 1)
    play_note(1, 15, track, 1)
    play_note(1, 3, track, 1, velocity=0)
