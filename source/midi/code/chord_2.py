...
def corus():
    ...
    play_note(1, 4, track, velocity=0)
    play_note(2, 5, track, -1)

    play_note(1, 6, track, velocity=0)

    play_note(1, 4, track, velocity=0)
    play_note(1, 5, track, -1)

    play_note(1, 24, track, velocity=0)
